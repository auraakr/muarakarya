            ...
            <div className="p-6">
                <div className="max-w-2xl space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-foreground">Tambah FAQ</h1>
                            <p className="text-sm text-muted-foreground">Isi form di bawah untuk menambah pertanyaan baru.</p>
                        </div>
                    </div>
                        ...
                        <div className="p-6 space-y-5">
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows={3}
                                    className="w-full rounded-lg border border-input bg-background text-foreground px-3.5 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#135b97]/40 focus:border-[#135b97] resize-none placeholder:text-muted-foreground transition-colors"
