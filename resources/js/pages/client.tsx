    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-slate-50 text-gray-800 scroll-smooth">
                ...
                {/* ── Navbar (Diambil dari welcome.tsx) ── */}
                <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-slate-100">
                    <nav className="max-w-7xl mx-auto px-4 lg:px-8 h-16 flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            <Link href="/" className="text-sm text-gray-600 hover:text-blue-700 transition-colors font-medium">Beranda</Link>
                            <Link href="/#tentang" className="text-sm text-gray-600 hover:text-blue-700 transition-colors font-medium">Tentang Kami</Link>
                            <Link href="/#layanan" className="text-sm text-gray-600 hover:text-blue-700 transition-colors font-medium">Layanan</Link>
                            <span className="text-sm text-blue-700 transition-colors font-bold cursor-default">Partner</span>
                        </div>
